...
IMPUESTOS_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_imp"),
...
DEPARTAMENTOS_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_dep"),
...
MARCAS_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_mar"),
...
SECCIONES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_sec"),
...
PROVEEDORES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_pro"),
...
PAISES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_pai"),
...
ESTADOS_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_est"),
...
CIUDADES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_ciu"),
...
VENDEDORES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_ven"),
...
SUCURSALES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_suc"),
...
ALMACENES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_alm"),
...
CLIENTES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_cli"),
...
CLASES_CLIENTES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_cla"),
...
CONCEPTOS_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_con"),
...
RENGLONES_ALMACENES_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.FULL_SNAPSHOT,
    natural_key=("source_empresa", "cod_alm", "cod_art"),
...
VENTAS_DIARIAS_V3 = QueryDefinition(
    ...
    natural_key=("source_empresa", "tipo_documento", "cod_suc", "documento", "renglon"),
    required_columns=("tipo_documento", "cod_suc", "documento", "renglon", "cod_alm"),
    sql_path=_PACKAGE_ROOT / "transactions" / "ventas_diarias_v3.sql",
    schema_path=_PACKAGE_ROOT / "schemas" / "ventas_diarias_v3.json",
    allowed_companies=_ALLOWED_COMPANIES,
    parameters=(
        ParamSpec(name="fec_des", type=ParamType.DATE),
        ParamSpec(name="fec_has", type=ParamType.DATE),
...
RENGLONES_MONEDAS_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.INCREMENTAL_BY_DATE,
    natural_key=("source_empresa", "cod_mon", "renglon"),
...
RENGLONES_APRECIOS_V1 = QueryDefinition(
    ...
    transport=Transport.GENERIC_SQL_API,
    load_strategy=LoadStrategy.INCREMENTAL_BY_DATE,
    natural_key=("source_empresa", "documento", "renglon"),
...
_REGISTRY: dict[str, QueryDefinition] = {
    ...
    VENTAS_DIARIAS_V3.query_id: VENTAS_DIARIAS_V3,
